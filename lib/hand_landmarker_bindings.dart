...
extension MyHandLandmarker$$Methods on MyHandLandmarker {
  ...
  static final _id_getActiveDelegate = MyHandLandmarker._class.instanceMethodId(r'getActiveDelegate', r'()Ljava/lang/String;');
  static final _getActiveDelegate = jni$_.ProtectedJniExtensions.lookup<
          jni$_.NativeFunction<jni$_.JniResult Function(
  ...
  /// from: `public fun getActiveDelegate(): kotlin.String`
  /// The returned object must be released after use, by calling the [release] method.
  jni$_.JString getActiveDelegate() {
    return _getActiveDelegate(reference.pointer, _id_getActiveDelegate.pointer).object<jni$_.JString>();
  }
